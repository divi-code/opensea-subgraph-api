## Opensea-Clone subgraph

![Opensea-Clone subgraph]( )

### How to use the API

Try it out [here](https://thegraph.com/hosted-service/subgraph/ )
...
This subgraph indexes data from [Opensea-Clone](https://etherscan.io/address/0x5180db8F5c931aaE63c74266b211F580155ecac8) smart contract transactions and makes them queryable.
...
```sh
git clone git@github.com:dabit3/opensea-Clone-api.git

cd opensea-clone-api
...
5. Replace `username/apiname` in `package.json` with your username and apiname, for example: `divi-code/opensea-clone-api`
